...
Для каждого замера выберите в игре относительно ровный отрезок 100–300 м. В окне
калибровки нажмите `C` для начала, введите расстояние с игрового маркера и `Enter`,
пройдите до конца и снова нажмите `C`. Команда использует тот же screen gate,
